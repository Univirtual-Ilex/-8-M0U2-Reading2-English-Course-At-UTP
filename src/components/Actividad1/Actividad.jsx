...
const Actividad_base =  ({staticContext, ...props}) => {
    return (
        <Container bgImage='./src/bg_actividad1.png' {...props} h={32}>
            ...
            <UiButtonsContainer>
                <ButtonUi icon='ilx-ayuda' tooltip='Read the next email and then choose the correct answer A,B, C, or D. .' />
